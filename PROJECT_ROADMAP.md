...
- 1차로 Hero 문구, My Library 개념 카드, 연결된 자료 카드를 추가했다(전체 리디자인 아님).
...
### 4.6 개념 그래프 → 학습 전략 도구 전환 (세션/간격반복)

- 개념 그래프의 "지도 보기"를 학습 전략 도구로 확장한다.
- 학습 세션 엔드포인트로 개념을 한 번에 하나씩 설명해보는 흐름을 지원한다.
